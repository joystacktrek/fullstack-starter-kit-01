  ...
  return (
    ...
    <div className="flex justify-center flex-wrap items-center h-screen">   
      ...
      <div className="w-full  md:w-1/2 px-3 mb-6 md:mb-0 "> 
          <label htmlFor="first-name" className="block uppercase text-left  text-gray-700 text-xs font-bold" >First Name</label>
       ...
       <div className="w-full md:w-1/2 px-3">
        ...
        <button type="submit" disabled={!passwordMatch} className={!passwordMatch ? " bg-red-500 text-white py-2 px-4 rounded block uppercase font-bold mb-10" : " bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded block uppercase   font-bold mb-10"}>Sign Up</button>
